					...
					<form method="post"
						...
						<!--div class="mb-3">
							<label for="formGroupExampleInput" class="form-label">Stock</label>
          					<input type="number" min="0" max="99999" class="form-control" id="cantInput" placeholder="Stock" required="">
						  </div-->
						  <div class="mb-3">
							<label for="exampleFormControlTextarea1" class="form-label">Stock</label>
							<input name="stock" type="number" class="form-control" id="exampleFormControlTextarea1" maxlength="7">
						  </div>
